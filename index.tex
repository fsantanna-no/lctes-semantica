...
%
It supports advanced features, such as safe shared-memory concurrency and
abortion of execution lines, while enforcing internal determinism and
time-bounded reactions.
%
In this paper, we present a small-step structural operational semantics for
\CEU and prove that under it program reactions are deterministic and always
terminate.
%
Thus, given the same timeline of input events, the same \CEU program in the
same initial memory state will always react in bounded time and arrive at the
