...
of~$\ceu{\Fin}$ and~$\ceu{\Loop}$ expressions, is formalized by the
...
\begin{proof}
  ...
  \begin{case}
    ...
    \begin{subcase}
      $p'=\ceu{\Nop}$.
      %%
      Then, by~\R{loop-nop} and by Assumption~\ref{ass.term-nst-loop},
      \begin{align}
      ...
      \begin{subsubcase}
        $p_1''=\ceu{\Break\AtLoop{p''}}$.
        From~\eqref{thm.term-nst-*.loop-adv.eq1}, by~\R{loop-brk},
        \begin{align*}
        \<\ceu{\Nop\AtLoop{p''}},n,\nil>
        &\nst[1]\<\ceu{\Loop{p''}},n,\nil>\\
        &\nst[*]\<\ceu{\Break\AtLoop{p''}},n,e>\\
  ...
  \begin{case}
    $p=\ceu{{p'}\Or{p''}}$.
    %%
    $p=\ceu{{p'}\Or{p''}}$.  Then, by~\R{or-expd},
    \[
      \<\ceu{{p'}\Or{p''}},n,\nil>
