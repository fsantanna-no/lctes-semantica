...
\begin{proof}
  ...
  \item$p=\ceu{\IfElse{p}{p_1}{p_2}}$.
    %%
    There are two subcases, depending on the value of~$\ceu{\Mem(\Id)}$.
    \begin{casex}
  ...
  \item$p=\ceu{p_1;\,p_2}$.
    %%
    There are three subcases, depending on the structure of~$p_1$
    \begin{casex}
    ...
    \item\label{lem.x.rank-nst.seq-adv}$p_1\ne\ceu{\Nop},\ceu{\Break}$.
      ...
      \end{equation}
      There are two subcases, depending on whether or not~$e'$ is the empty
      event.
      \begin{casex}
      \item$e'=\nil$
        %%
  ...
  \item$p=\ceu{{p_1}\AtLoop{p_2}}$.
    ...
    \item\label{lem.x.rank-nst.loop-adv}$p_1\ne\ceu{\Nop},\ceu{\Break}$.
      ...
      % \end{equation}
      %%
      There are two subcases depending on the value of~$\pot'(p)$.
      \begin{casex}
      \item$\pot'(p)=\pot'(p_1)$.
        %%
  ...
  \item\label{lem.x.rank-nst.and}$p=\ceu{{p_1}\AtAnd{p_2}}$.
    %%
    There are two subcases, depending whether or not~$p_1$ is blocked at
    stack level~$n$.
    \begin{casex}
  ...
  \item$p=\ceu{{p_1}\AtOr{p_2}}$.
    %%
    There are two subcases, depending whether or not~$p_1$ is block at stack
    level~$n$.
    \begin{casex}
...
\begin{proof}
  ...
  \begin{induction}
    Let~$\<i,j>\ne\<0,0>$.
    %%
    There are two subcases, depending whether or not~$\delta$ is
    nested-irreducible.
    \begin{casex}
    \item\label{thm.x.term.Hnst}$\delta$~is nested-irreducible.
      %%
      There are two cases, depending on the value of~$j$.
      \begin{casex}
      ...
      \item\label{thm.x.term.Hnst-j>0}$j>0$.
        %%
        There are two subcases, depending whether or not~$e$ is the empty
        event.
        \begin{casex}
