...
guarantee that it will always behave the same.
This can be done in negligible time in a controlled development environment and
with multiple users (e.g., multiple developers each on its desktop) before
deploying the application in the actual device.
...
to entering in standby mode, which is can improve the autonomy of
