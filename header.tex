...
\newcommand{\code}[1]{{\relax{\texttt{#1}}}}
%\let\code\lstinline
\usepackage{xspace}
\newcommand{\ax}{[a]}
\newcommand{\bx}{[b]}
...
%%
\newlist{casex}{enumerate}{4}
\SetLabelAlign{casex}{\emph{Case}~#1.\hfil}
\setlist[casex]{itemsep=1ex,leftmargin=\parindent,labelindent=\parindent,
labelwidth=*,align=casex,label*=.\arabic*}
\setlist[casex,1]{label=\arabic*,leftmargin=0pt,labelindent=0pt}
