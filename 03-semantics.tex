...
\end{align*}
%
First, a $\xrightarrow[out]{push}$ starts a nested reaction at level $1$ (case
$a$).
Then, a series of alternations between $\NST$ transitions followed by a single
$\OUT$ transition represent nested reactions and stack operations (case $b$).
Finally, at some point, a $\xrightarrow[out]{pop}$ lowers the stack level to
$0$ and terminates the reaction.

The $\NST$ transition rules for the primary expressions are as follows:
%
{ \setlength{\jot}{20pt}
\begin{align*}
